  ...
  t4: {list: [
    {name: "独播库",
     ...
     address: "https://bilibili.jsnzkpg.uk"},
      ...
      {name: "rrsp丨JS",
      address: "http://jiduo666.dpdns.org/rrsp.php"},
      {name: "embyj丨聚合",
 ...
 emby: [
  {
    ...
    {
      name: "bangumi",
      server: "https://emby.bangumi.ca:443",
      username: "tangsan",
      password: "tangsan",
      deviceName: "Hills Windows",
      client: "Hills Windows",
    ...
    {
      name: "hx−emby",
      server: "https://embyp.ystel.cn:443",
      username: "test",
      password: "test",
      deviceName: "Hills Windows",
      client: "Hills Windows",
    ...
    {
      name: "番剧收藏夹",
      server: "http://107.175.233.82:8091",
      username: "share",
      password: "share",
      deviceName: "Hills Windows",
      client: "Hills Windows",
    ...
    {
      name: "IpacEL",
      server: "https://emby.ipacel.cc:443",
      username: "visit",
      password: "",
      deviceName: "Hills Windows",
      client: "Hills Windows",
    ...
    {
      name: "ANI EMBY",
      server: "http://emby.ikun6.dpdns.org:80",
      username: "linuxdo",
      password: "linuxdo",
      deviceName: "Hills Windows",
      client: "Hills Windows",
    ...
    {
      name: "AniHub",
      server: "https://ani.cappuccino.moe:443",
      username: "linux.do",
      password: "linux.do",
      deviceName: "Hills Windows",
      client: "Hills Windows",
